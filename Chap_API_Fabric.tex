...
%%%%
\subsubsection{Initialize the coord structure}
...
%%%%
\subsubsection{Destruct the coord structure}
...
%%%%
\subsubsection{Create a coord array}
...
%%%%
\subsubsection{Release a coord array}
