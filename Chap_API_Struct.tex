...
Number of allocated slots in a session - each slot may or may not be occupied by an executing process. Note that this attribute is the equivalent to the combination of \refattr{PMIX_SESSION_INFO_ARRAY} with the \refattr{PMIX_NUM_SLOTS} entry in the array - it is included in the Standard for historical reasons.
}
...
%
\declareAttribute{PMIX_FWD_STDDOAG}{"pmix.fwd.stddiag"}{bool}{
